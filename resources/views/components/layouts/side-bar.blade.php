<x-ui.logo width="100" height="100" class="align-self-center mb-3" />
...
<ul class="nav nav-pills flex-column mb-auto">
    ...
    <li class="nav-item">
        <a href="{{ Auth::user()->pricelist ? route('pricelists.show', Auth::user()->pricelist->id) : route('pricelists.create')}}"
            class="nav-link d-flex align-items-center {{ request()->routeIs('pricelists.*') ? 'active' : '' }}"
            aria-current="page">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <li>
        <a href="#"
            class="nav-link d-flex align-items-center {{ request()->routeIs('categories.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
